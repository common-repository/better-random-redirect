...
class BetterRandomRedirect {
    ...
    public static function random_url_shortcode( $atts ) {
        ...
        $transient_id = apply_filters('brr_transient_id_filter', $transient_id, get_locale());
        ...
        // build URL base
        $url_base = site_url();
        $url_base = apply_filters('brr_url_base_filter',$url_base, get_locale());
        $url_base .= '/'.$url_slug.'/';
    ...
    public static function do_redirect() {
        ...
        $match_url = $url_base;
        if (isset($q_config['language']) && isset($q_config['default_language']) && $q_config['language'] != $q_config['default_language']) {
