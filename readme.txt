...
= 1.3.17 =
 * Resolve warning for empty string key
 ...
 * Fixed warnings under some rare cases
 
= 1.3.15 =

 * Cleaned up user configurable options sanitization / validation
 
= 1.3.14 =

 * Tested with 5.5.3
 * Standardised cache headers
